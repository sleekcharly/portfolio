...
const about = {
  title: 'About me',
  description:
    "I'm a Software Developer with a solid background in telecommunications and technical support. I specialize in building responsive, user-focused web applications using technologies like React, Next.js, TypeScript, Firebase, and PostgreSQL.",
  info: [
    {
      fieldName: 'Name',
      fieldValue: 'Charles Ukasoanya',
    },
    {
      fieldName: 'Phone',
      fieldValue: '(+234) 803 786 6963',
    },
    {
    ...
    {
      fieldName: 'Email',
      fieldValue: 'c_ukasoanya@yahoo.com',
    },
  ],
};
