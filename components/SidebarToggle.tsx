...
function SidebarToggle() {
  ...
  const buttonStyles = `relative w-16 h-16 rounded-full 
    bg-gradient-to-br from-[#800000] via-red-500 to-fuchsia-500 
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 group">
      {/* Animated rings */}
      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#800000] to-red-500 opacity-20 blur-2xl animate-ping [animation-duration:2s]" />
      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#800000] to-red-500 opacity-30 blur-xl animate-pulse [animation-duration:3s]" />
