...
const BlogSidebar = () => {
  return (
    <aside className="bg-darkTheme w-full md:max-w-xs pt-15 pb-10 md:h-screen flex flex-col sm:items-center md:items-start pl-20 sm:pl-0 md:pl-10 space-y-7 md:fixed">
      <motion.div
        initial={{ scale: 0 }}
        whileInView={{ scale: 1 }}
      ...
      <motion.h1
        ...
        className="text-6xl font-pirata-one text-white w-[250px] md:w-full "
      >
        Charles Ukasoanya&apos;s Blog
      </motion.h1>

      <ul className="text-gray-400 font-jetMono flex flex-col gap-5 sm:-ml-15 md:ml-0">
        <motion.li
          initial={{ y: -20, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
      ...
      <motion.ul
        ...
        className="flex items-center gap-10 mt-4 text-white sm:-ml-25 md:ml-0"
      >
        <li>
